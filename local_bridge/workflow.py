...
def main():
    ...
    pushed={} if a.no_push else send_all(subject,body);print(json.dumps({'prediction_id':pid,'prediction':result,'news_errors':news['errors'],'push':pushed},ensure_ascii=False,indent=2))
