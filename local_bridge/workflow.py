...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('--symbol',default='XAUUSD');ap.add_argument('--hours',type=int);ap.add_argument('--manual',action='store_true');ap.add_argument('--no-push',action='store_true');ap.add_argument('--no-publish',action='store_true');a=ap.parse_args()
